...
export const readConfiguration = () => {
  const envVars = {
    ...
    bffCtpClientId: process.env.CTP_CLIENT_ID as string,
    bffCtpClientSecret: process.env.CTP_CLIENT_SECRET as string,
    ctMaxRetry: process.env.CT_MAX_RETRY as string,
    dynamodb: {
