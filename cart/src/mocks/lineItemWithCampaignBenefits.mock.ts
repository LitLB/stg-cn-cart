        ...
        freeGiftProducts: [ // TODO: Free Gift
            {
                ...
                categories: [],
                categoryOrderHints: {},
                slug: { 'th-TH': 'o-add-on-1', 'en-US': 'o-add-on-1' },
                metaTitle: { 'th-TH': '', 'en-US': '' },
                metaDescription: { 'th-TH': '', 'en-US': '' },
                searchKeywords: {},
        ...
        freeGiftProducts: [ // TODO: Free Gift
            {
                ...
                name: { 'th-TH': 'o-add-on-2', 'en-US': 'o-add-on-2' },
                categories: [],
                categoryOrderHints: {},
                slug: { 'th-TH': 'o-add-on-2', 'en-US': 'o-add-on-2' },
                metaTitle: { 'th-TH': '', 'en-US': '' },
                metaDescription: { 'th-TH': '', 'en-US': '' },
                searchKeywords: {},
                hasStagedChanges: false,
                ...
                variants: [
                    {
                        attributes: [
                            { name: 'product_id', value: 'o-add-on-2' },
                            {
                                name: 'akeneo_id',
...
export const lineItemWithCampaignBenefitsMock = [
    {
        id: 'a9e64a73-0341-4213-9fe7-1c5137f76a22',
        ...
        productSlug: { 'th-TH': 'o-main-product-1', 'en-US': 'o-main-product-1' },
        variant: {
            id: 1,
            sku: 'o-main-product-sku-1001',
            ...
            attributes: [
                ...
                { name: 'status', value: { key: 'enabled', label: 'Enabled' } },
                {
                    name: 'akeneo_id',
        ...
        price: {
            id: '32f2de90-56b3-48ec-b465-7a2b5fdcc576',
            value: {
                type: 'centPrecision',
                currencyCode: 'THB',
                centAmount: 1250000,
        ...
        perMethodTaxRate: [],
        addedAt: '2024-12-19T07:41:45.926Z',
        lastModifiedAt: '2024-12-19T07:41:45.926Z',
        state: [
            {
                quantity: 1,
                state: {
        ...
        custom: {
            ...
            fields: { productType: 'main_product', productGroup: 1 },
        },
        privilege: {},
        discounts: [],
        otherPayments: [],
