        ...
        if (pkgAttr && typeof pkgAttr.value === "string") {
            ...
            if (!pkg.masterVariant.connector) {
                pkg.masterVariant.connector = {
                    description: {
                        "en-US": "Monthly fee 1,299 | 12-month contract | Package fee will be charged on the invoice | Early cancellation penalty 10,000 THB",
                        "th-TH": "ค่าบริการรายเดือน 1,299 | สัญญา 12 | ค่าแพ็คเกจ รายเดือนจะเรียกเก็บในใบแจ้งค่าบริการ | ค่าปรับกรณียกเลิกสัญญาก่อนกำหนด 10,000 บาท",
                    }
                };
            }
