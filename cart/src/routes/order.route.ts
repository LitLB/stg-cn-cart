...
orderRouter.get('/v1/tracking/:orderNumber', validateRequest({ params: getOrderTrackingParamsSchema, query: getOrderTrackingQuerySchema }), orderController.getOrderTracking);
